...
FF8_CHARACTERS = {
    ...
    "quistis_garden_ch1": "Quistis Trepe from FF8, beautiful young woman with long blonde hair and glasses, blue eyes, instructor outfit, warm welcoming smile, Balamb Garden classroom",
    "quistis_garden_ch5": "Quistis Trepe from FF8, beautiful young woman with long blonde hair and glasses, blue eyes, SeeD uniform, troubled worried expression, Balamb Garden",
    "cid_commander": "Headmaster Cid from FF8, older man with glasses and short brown hair, wearing suit, proud expression, naming Squall as commander, Balamb Garden",
    "cid_orphanage": "Headmaster Cid from FF8, older man with glasses, wearing casual clothes, melancholic expression, standing at coastal orphanage, sunset",
    "zell_garden": "Zell Dincht from FF8, young man with spiky blonde hair and tribal face tattoo, blue eyes, SeeD cadet uniform, pumping fist excitedly, Balamb Garden",
    "zell_trabia": "Zell Dincht from FF8, young man with spiky blonde hair and tribal face tattoo, blue eyes, winter coat, somber expression, snowy Trabia Garden ruins",
    "selphie_dollet": "Selphie Tilmitt from FF8, cheerful girl with flipped brown hair, green eyes, yellow dress, breathless from running, just arrived at Dollet exam",
    "selphie_missile": "Selphie Tilmitt from FF8, girl with flipped brown hair, green eyes, military disguise uniform, determined serious expression, missile base interior",
    "selphie_fh": "Selphie Tilmitt from FF8, cheerful girl with flipped brown hair, green eyes, yellow dress, excited expression, planning concert at Fisherman's Horizon",
    "rinoa_ball": "Rinoa Heartilly from FF8, young woman with black hair in elegant white party dress, brown eyes, beautiful smile, SeeD graduation ballroom, dancing",
    "rinoa_deling": "Rinoa Heartilly from FF8, young woman with black hair, brown eyes, blue duster outfit, worried expression, Deling City at night",
    "rinoa_esthar": "Rinoa Heartilly from FF8, young woman with black hair, brown eyes, blue outfit, recovering from coma, gentle tired expression, Esthar futuristic setting",
    "rinoa_final": "Rinoa Heartilly from FF8, young woman with black hair, brown eyes, blue outfit with angel wing motif, determined brave expression, ready for final battle",
    "irvine_gg": "Irvine Kinneas from FF8, tall young man with long brown hair in ponytail, cowboy hat, trench coat, confident smirk, Galbadia Garden",
    "irvine_trabia": "Irvine Kinneas from FF8, tall young man with long brown hair, cowboy hat, trench coat, emotional serious expression, snowy Trabia Garden, revealing truth",
    "seifer_garden": "Seifer Almasy from FF8, tall young man with blonde hair and facial scar, grey trench coat, arrogant confident smirk, Balamb Garden rival",
    "seifer_deling": "Seifer Almasy from FF8, tall young man with blonde hair and scar, dark knight outfit, fanatical expression, standing beside sorceress, Deling City night",
    "seifer_prison": "Seifer Almasy from FF8, tall young man with blonde hair and scar, dark outfit, cruel intimidating expression, prison interrogation room, menacing",
    "edea_sorceress": "Edea Kramer as Sorceress from FF8, elegant woman in ornate dark sorceress dress with dramatic headdress, glowing eyes, powerful menacing aura, parade float",
    "laguna_dream_1": "Laguna Loire from FF8, young soldier with long dark hair, Galbadian military uniform, nervous clumsy expression, leg cramp, pub setting with piano",
    "laguna_dream_2": "Laguna Loire from FF8, young soldier with long dark hair, battle-worn military gear, determined expression, Centra excavation site, fighting monsters",
    "ellone_ship": "Ellone from FF8, young woman with short brown hair and gentle face, blue shawl, kind hopeful expression, White SeeD Ship deck, ocean breeze",
    "ellone_lunar": "Ellone from FF8, young woman with short brown hair, space station uniform, worried urgent expression, Lunar Base interior, viewing Earth",
    "fujin_garden": "Fujin from FF8, young woman with short silver hair and eyepatch, dark outfit, stoic stern expression, Balamb Garden, disciplinary committee",
    "raijin_garden": "Raijin from FF8, large muscular man with dark skin, simple clothes with staff, friendly grin, Balamb Garden, disciplinary committee member",
    "fujin_balamb": "Fujin from FF8, young woman with short silver hair and eyepatch, dark outfit, commanding expression, occupying Balamb Town, military posture",
    "raijin_balamb": "Raijin from FF8, large muscular man with dark skin, casual clothes, conflicted expression, occupying Balamb Town, reluctant enforcer",
    "fujin_pandora": "Fujin from FF8, young woman with short silver hair and eyepatch, dark outfit, emotional tearful expression breaking character, Lunatic Pandora crystal interior, pleading",
    "zone_timber": "Zone from FF8, young resistance leader with dark hair and headband, casual rebel clothes, enthusiastic but stomach-ache prone, train hideout, Timber resistance",
    "watts_timber": "Watts from FF8, young resistance member with cap and round face, eager nervous expression, scout outfit, Timber train station, intelligence gatherer",
    "general_caraway": "General Caraway from FF8, stern middle-aged military officer with short dark hair, decorated Galbadian general uniform, authoritative cold expression, mansion office",
    "queen_of_cards_esthar": "Queen of Cards from FF8, elegant woman with dark hair wearing ornate card-themed outfit, mysterious knowing smile, Esthar futuristic city background",
}
